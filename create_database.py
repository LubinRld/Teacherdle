...
('MARQUIE','M','1994','TP','ELECTRONIQUE','Aucune');
    ...
    ("SQÉLITE","CHASSEL"),
    ("Vous êtes vraiment des têtes de pioches en calcul algébrique","SALOMON"),
    ...
    ("On est tous déjà passé sous des lignes Hautes Tensions en entendant ce bruit CARACTÉRISTIQUE","WEEBER"),
    ...
    ("Ça fait parti de ces séances clefs", "WEEBER"),
